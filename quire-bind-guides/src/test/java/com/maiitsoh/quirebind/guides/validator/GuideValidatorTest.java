 ...
 */
package com.maiitsoh.quirebind.guides.validator;

import com.maiitsoh.quirebind.guides.loader.GuideLoader;
import com.maiitsoh.quirebind.guides.model.BindingGuide;
import com.maiitsoh.quirebind.guides.model.GuideMetadata;
import com.maiitsoh.quirebind.guides.model.GuideSection;
import com.maiitsoh.quirebind.guides.validator.GuideValidator.ValidationReport;
...
class GuideValidatorTest {
    ...
    void allKnownTechniqueIdsAreAccepted() {
        for (com.maiitsoh.quirebind.core.model.BindingTechnique bt
                : com.maiitsoh.quirebind.core.model.BindingTechnique.values()) {
            GuideMetadata meta = GuideMetadata.builder()
