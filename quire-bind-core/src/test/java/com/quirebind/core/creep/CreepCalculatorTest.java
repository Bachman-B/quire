...
import com.quirebind.core.model.CreepSheetResult;
...
import com.quirebind.core.model.PageSequence;
import com.quirebind.core.model.PageType;
import com.quirebind.core.model.QuirePage;
    ...
    void unnumberedPagesProduceEmptyPageNumbers() {
        ...
        QuireProject project = QuireProject.builder()
                ...
                .numberingConfig(NumberingConfig.builder().bodyStyle(
                        com.quirebind.core.model.FolioStyle.NONE).build())
                .markConfig(MarkConfig.builder().build())
                .creepConfig(CreepConfig.builder().build())
                .build();
