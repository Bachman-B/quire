...
class ImpositionGroupTest {

    @Test
    void valuesExist() {
        assertEquals(3, ImpositionGroup.values().length);
    }

    @Test
    void valueOfRoundtrips() {
        for (ImpositionGroup g : ImpositionGroup.values()) {
            assertEquals(g, ImpositionGroup.valueOf(g.name()));
        }
    }
}
