...
class ImpositionLayoutTest {

    @Test
    void valuesExist() {
        assertEquals(3, ImpositionLayout.values().length);
    }

    @Test
    void valueOfRoundtrips() {
        for (ImpositionLayout l : ImpositionLayout.values()) {
            assertEquals(l, ImpositionLayout.valueOf(l.name()));
        }
    }
}
